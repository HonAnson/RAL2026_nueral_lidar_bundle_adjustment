...
\begin{figure*}[h!]
	...
	\caption{\textbf{Comparison of RGB NeRF-BA and LiDAR NeRF-BA in Volume Sampling along Depth/Range.}
		...
		(b) Sampling around high-probability spike in $\sigma(z)$ (highlighted pink region) is critical to produce a differnece in the ray termination distribution $h(z)$ and $h(z+\epsilon)$ after alpha blending, which provides non-vanishing $\frac{\partial \hat{h}(z_i)}{\partial \mathbf{x}_i}$ for pose optimization.
...
\begin{figure}
	\centering
	\includegraphics[width=0.47\textwidth]{images/ray_term_dist_comparison_1.png}
