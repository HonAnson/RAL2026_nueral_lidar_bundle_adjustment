...
2) We propose a simple yet efficient strategies for volume sampling and positional encoding tailored to LiDAR NeRF-BA, together with a LiDAR-specific loss function;  
